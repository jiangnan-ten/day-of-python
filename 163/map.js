...
require(['echarts', 'echarts/chart/map', 'echarts/chart/pie'], function(ec) {
    $.ajax({
            url: 'http://139.129.92.21:8090/chart.php?parm=map',
            dataType: 'json', 
                ...
                if(res) {
                    ...
                    map.on(ecConfig.EVENT.MAP_SELECTED, function (param){
                        ...
                        if (selectedProvince) {
                            $.ajax({
                                dataType:'json',
                                url: 'http://139.129.92.21:8090/chart.php?parm=mappie&province='+selectedProvince,
                                success: function(res) {
                                    if (res) {
                                        for (var i in res) {
                                            mappie_data.push({
