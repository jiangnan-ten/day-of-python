//中奖用户
$.ajax({
    url: 'http://ten.com/163/chart.php?parm=userrank',
    dataType: 'json',
    success: function(res) {
        if (res) {    
            ...
            var userrank = echarts.init($('#userrank')[0]); 
            var userrank_pie = echarts.init($('#userrank_pie')[0]);
            var userhistory_line = echarts.init($('#userhistory_line')[0]);
            
            /*某用户中奖详情*/
            userrank.on(echarts.config.EVENT.CLICK, function (param){
                ...
                if (cid) {
                    //用户奖品 饼图
                    $.ajax({
                        url: 'http://ten.com/163/chart.php?parm=useraward&cid='+cid,
                        dataType: 'json',
                        async: false,
                        success: function(res) {
                            if (res) {
                    ...
                    //用户中奖历史 折线图
                    $.ajax({
                        url: 'http://ten.com/163/chart.php?parm=userhistory&cid='+cid,
                        dataType: 'json',
                        async: false,
                        success: function(res) {
                            if (res) {
